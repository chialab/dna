...
describe('[React]', () => {
    describe('Root', () => {
        ...
        it('should render simple element', () => {
            ...
            expect(elem.outerHTML).to.be.equal(`<${tagBase} :host="${tagBase}" :defined=""><h1 :scope="${tagBase}">Hello World</h1><div :scope="${tagBase}" class="tags"></div></${tagBase}>`);
        });
        ...
        it('should render native element', () => {
            ...
            expect(elem.outerHTML).to.be.equal(`<article is="${tagNative}" :host="${tagNative}" :defined=""><h1 :scope="${tagNative}">Hello World</h1><div :scope="${tagNative}" class="tags"></div></article>`);
        });

        it('should render element with attribute', () => {
            ReactDOM.render(<Root><react-component attr="2"></react-component></Root>, wrapper);
            let elem = wrapper.children[0];
            expect(elem.outerHTML).to.be.equal(`<${tagBase} attr="2" :host="${tagBase}" :defined=""><h1 :scope="${tagBase}">Hello World</h1><div :scope="${tagBase}" class="tags"></div></${tagBase}>`);
        });
        ...
        it('should render element with observed attribute', () => {
            ...
            let elem = wrapper.children[0];
            expect(elem.outerHTML).to.be.equal(`<${tagBase} attr="2" :host="${tagBase}" :defined="" name="Alan"><h1 :scope="${tagBase}">Hello Alan</h1><div :scope="${tagBase}" class="tags"></div></${tagBase}>`);
        });
        ...
        it('should render element with property', () => {
            ...
            let elem = wrapper.children[0];
            expect(elem.outerHTML).to.be.equal(`<${tagBase} :host="${tagBase}" :defined="" name="Alan"><h1 :scope="${tagBase}">Hello Alan</h1><div :scope="${tagBase}" class="tags">test</div></${tagBase}>`);
        });
        ...
        it('should render element with slotted text', () => {
            ...
            let elem = wrapper.children[0];
            expect(elem.outerHTML).to.be.equal(`<${tagBase} :host="${tagBase}" :defined="" name="Alan"><h1 :scope="${tagBase}">Hello Alan</h1><div :scope="${tagBase}" class="tags">test</div>Test</${tagBase}>`);
        });
        ...
        it('should render element with slotted element', () => {
            ...
            let elem = wrapper.children[0];
            expect(elem.outerHTML).to.be.equal(`<${tagBase} :host="${tagBase}" :defined="" name="Alan"><h1 :scope="${tagBase}">Hello Alan</h1><div :scope="${tagBase}" class="tags">test</div>Test <strong>Test</strong></${tagBase}>`);
        });
    });
});
