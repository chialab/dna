...
export enum Code {
    ...
    PREFER_PROPERTIES = '`properties` getter has been deprecated in DNA 3.0, use the static `properties` getter',
    PREFER_LISTENERS = '`events` getter has been deprecated in DNA 3.0, use the static `listeners` getter',
    ...
    USE_REGISTRY = '`define` and `get` methods had been deprecated in DNA 3.0, use `customElements` instead',
}
