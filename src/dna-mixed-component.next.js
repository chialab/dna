...
function triggerCallbacks(ctx, callbackKey, args) {
    ...
    let callbacks = ctr[secretKey] || (ctr.__proto__ && ctr.__proto__[secretKey]);
...
function iterateBehaviors(ctx, behavior) {
    if (Array.isArray(behavior)) {
        ...
        var callbacks = componentCallbacks,
 ...
 */
var componentCallbacks = ['onRegister', 'createdCallback', 'attachedCallback', 'detachedCallback', 'attributeChangedCallback'];
