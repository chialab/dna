...
describe('Unit: DNAStyleComponent', () => {
    let elem1 = document.querySelector('test1-style-component');
    let elem2 = document.querySelector('test2-style-component');
    let elem3 = document.querySelector('test3-style-component');
    let elem4;
    let elem5;
    let elem6;
