...
render(<TestBuiltinElement active={true} nodeType={true} />);
// @ts-expect-error nodeType is a read-only property
render(<details is="x-test-builtin" active={true} nodeType={true} />);
// @ts-expect-error connectedCallback is a method
render(<details is="x-test-builtin" active={true} connectedCallback={() => {}} />);
