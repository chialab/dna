...
describe('[React]', () => {
    describe('Root', () => {
        ...
        it('should render element with attribute', () => {
            ...
            let elem = wrapper.children[0];
            expect(elem.outerHTML).to.be.equal(`<${tagBase} attr="2" is="${tagBase}"><h1>Hello World</h1><div class="tags"></div></${tagBase}>`);
        });
        ...
        it('should render element with observed attribute', () => {
            ...
            let elem = wrapper.children[0];
            expect(elem.outerHTML).to.be.equal(`<${tagBase} attr="2" is="${tagBase}" name="Alan"><h1>Hello Alan</h1><div class="tags"></div></${tagBase}>`);
        });
